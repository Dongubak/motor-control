...
## window pc에서의 adator 변수 값 \\Device\\NPF_{A3C1307F-C4D5-4126-8FCF-A191BF2B1257}
...
def main():
    ...
    try:
        ...
        # --- SDO 설정 (버스 시작 전) ---
        # SDO system data object (pp. 149)
        # 버스가 OP 상태에 들어가기 전에 속도, 가감속도 등 파라미터를 설정합니다.
        motor1.set_profile_velocity(rpm=50)  # 속도는 200 RPM 유지
